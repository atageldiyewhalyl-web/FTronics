...
import { specMarks } from '@/components/spec-marks'
import { cta } from '@/lib/site'

/* ---------------- spec icons ---------------- */

/* Resolved against the chip text so the 18 SKUs keep one source of truth: the
   spec strings stay the copy, and the mark is derived from them. Order
...
const specRules = [
  ...
  [/zoom/, 'zoom'],
  [/^ip\d/, 'weather'],
  [/dual-light|ir\s*\d/, 'night'],
  [/audio|spl/, 'audio'],
  [/kanäle|kanale|hybrid|channel/, 'channels'],
  [/sata|raid|anr/, 'storage'],
  [/poe|^\d+w$/, 'power'],
  [/sony|imx|cmos|f1\./, 'sensor'],
  [/ki-|vca|tracking|\bai\b|analytics/, 'ai'],
]
